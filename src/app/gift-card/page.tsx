              ...
              {(form.from || form.message) && (
                <div style={st.previewCard}>
                  <div style={st.previewHeader}>
                    <span style={st.previewLogo}>H</span>
                    <span style={st.previewBrand}>HADIYA</span>
                  </div>
                  <p style={st.previewTo}>Pour <strong>{form.firstName || "…"} {form.lastName}</strong></p>
                  {form.message && <p style={st.previewMessage}>"{form.message}"</p>}
...
const st: Record<string, React.CSSProperties> = {
  ...
  brandName: { fontFamily: "'Cormorant Garamond', serif", fontSize: 28, fontWeight: 300, letterSpacing: "0.35em", color: "#F4EFE6" },
